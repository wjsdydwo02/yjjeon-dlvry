    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <BoundedContext1499Delivery :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <BoundedContext1499Delivery :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import BoundedContext1499Delivery from './../BoundedContext1499Delivery.vue';

    export default {
        name: 'BoundedContext1499DeliveryManager',
        components: {
            BoundedContext1499Delivery,
        },
        props: {
            offline: Boolean
        },
